...
function initDecoratedAssociations(source, sequelize) {
  ...
  for (const association of associations) {
    ...
    switch (type) {
      case "BelongsTo":
        import_associations.BelongsToAssociation.associate(import_helpers.AssociationSecret, source, target, options);
        break;
      case "HasOne":
        import_associations.HasOneAssociation.associate(import_helpers.AssociationSecret, source, target, options);
        break;
      case "HasMany":
        import_associations.HasManyAssociation.associate(import_helpers.AssociationSecret, source, target, options);
        break;
      case "BelongsToMany":
        import_associations.BelongsToManyAssociation.associate(import_helpers.AssociationSecret, source, target, options);
        break;
      default:
