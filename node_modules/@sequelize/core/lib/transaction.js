...
class Transaction {
  ...
  async rollback() {
    ...
    try {
      await this.sequelize.queryInterface.rollbackTransaction(this, this.options);
  ...
  async setDeferrable() {
    if (this.options.constraintChecking) {
      await this.sequelize.queryInterface.deferConstraints(this.options.constraintChecking, { transaction: this });
    }
  }
  async begin() {
