...
class IBMiDialect extends import_abstract.AbstractDialect {
  ...
  constructor(sequelize) {
    ...
    this.connectionManager = new import_connection_manager.IBMiConnectionManager(this);
    this.queryGenerator = new import_query_generator.IBMiQueryGenerator(this);
    this.queryInterface = new import_query_interface.IBMiQueryInterface(this);
  }
  createBindCollector() {
