...
__export(query_generator_internal_exports, {
  IBMiQueryGeneratorInternal: () => IBMiQueryGeneratorInternal
});
...
class IBMiQueryGeneratorInternal extends import_query_generator_internal.AbstractQueryGeneratorInternal {
  addLimitAndOffset(options) {
    return (0, import_sql.formatDb2StyleLimitOffset)(options, this.queryGenerator);
  }
}
