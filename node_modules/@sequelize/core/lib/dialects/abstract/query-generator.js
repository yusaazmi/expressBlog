...
class AbstractQueryGenerator extends import_query_generator_typescript.AbstractQueryGeneratorTypeScript {
  ...
  insertQuery(table, valueHash, modelAttributes, options) {
    ...
    if ((0, import_get.default)(this, ["sequelize", "options", "dialectOptions", "prependSearchPath"]) || options.searchPath) {
      bindParam = void 0;
    }
  ...
  */
  ...
  parseConditionObject(conditions, path) {
    path = path || [];
    return (0, import_reduce.default)(conditions, (result, value, key) => {
