...
const CREATE_DATABASE_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["charset", "collate", "ctype", "encoding", "template"]);
const CREATE_SCHEMA_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["authorization", "charset", "collate", "comment", "ifNotExists", "replace"]);
const DROP_SCHEMA_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["cascade", "ifExists"]);
const DROP_TABLE_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["cascade"]);
const LIST_DATABASES_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["skip"]);
...
const RENAME_TABLE_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["changeSchema"]);
const SHOW_CONSTRAINTS_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["columnName", "constraintName", "constraintType"]);
const TRUNCATE_TABLE_QUERY_SUPPORTABLE_OPTIONS = /* @__PURE__ */ new Set(["cascade", "restartIdentity"]);
class AbstractQueryGeneratorTypeScript {
  ...
  escape(value, options = import_object.EMPTY_OBJECT) {
    if ((0, import_check.isPlainObject)(value) && import_operators.Op.col in value) {
  ...
  bulkDeleteQuery(tableName, options) {
    const table = this.quoteTable(tableName);
    const whereOptions = (0, import_model_utils.isModelStatic)(tableName) ? { ...options, model: tableName } : options;
    if (options.limit && this.dialect.supports.delete.modelWithLimit) {
      if (!(0, import_model_utils.isModelStatic)(tableName)) {
