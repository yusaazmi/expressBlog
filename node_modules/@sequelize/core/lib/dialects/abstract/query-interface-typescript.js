...
class AbstractQueryInterfaceTypeScript {
  ...
  async listDatabases(options) {
    ...
    return this.sequelize.queryRaw(sql, { ...options, type: import_query_types.QueryTypes.SELECT });
  }
  /**
  ...
  async listTables(options) {
    ...
    return this.sequelize.queryRaw(sql, { ...options, raw: true, type: import_query_types.QueryTypes.SELECT });
  }
  /**
   * Show all tables
   *
  ...
  async delete(tableName, options) {
    (0, import_deprecations.deleteToBulkDelete)();
    const deleteOptions = { ...options };
    const sql = this.queryGenerator.bulkDeleteQuery(tableName, deleteOptions);
    delete deleteOptions.replacements;
    return this.sequelize.queryRaw(sql, { ...deleteOptions, raw: true, type: import_query_types.QueryTypes.DELETE });
  }
  /**
   ...
   * @param options
   */
  async bulkDelete(tableName, options) {
    ...
    return this.sequelize.queryRaw(sql, { ...bulkDeleteOptions, raw: true, type: import_query_types.QueryTypes.DELETE });
  }
}
