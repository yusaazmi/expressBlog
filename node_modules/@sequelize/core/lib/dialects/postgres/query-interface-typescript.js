...
var import_query_interface_internal = require("../abstract/query-interface-internal.js");
var import_query_interface = require("../abstract/query-interface.js");
class PostgresQueryInterfaceTypescript extends import_query_interface.AbstractQueryInterface {
  ...
  constructor(dialect, internalQueryInterface) {
    internalQueryInterface ??= new import_query_interface_internal.AbstractQueryInterfaceInternal(dialect);
