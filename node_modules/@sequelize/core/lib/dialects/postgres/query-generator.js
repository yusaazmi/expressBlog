...
class PostgresQueryGenerator extends import_query_generator_typescript.PostgresQueryGeneratorTypeScript {
  #internals;
  ...
  createTableQuery(tableName, attributes, options) {
    ...
    const pks = (0, import_reduce.default)(attributes, (acc, attribute, key) => {
