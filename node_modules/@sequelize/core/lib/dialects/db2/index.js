...
class Db2Dialect extends import_abstract.AbstractDialect {
  ...
  constructor(sequelize) {
    ...
    this.connectionManager = new import_connection_manager.Db2ConnectionManager(this);
    this.queryGenerator = new import_query_generator.Db2QueryGenerator(this);
    this.queryInterface = new import_query_interface.Db2QueryInterface(this);
