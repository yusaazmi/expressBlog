...
class HasManyAssociation extends import_base.MultiAssociation {
  ...
  constructor(secret, source, target, options, parent, inverse) {
    ...
    this.inverse = inverse ?? import_belongs_to.BelongsToAssociation.associate(secret, target, source, (0, import_object.removeUndefined)({
  ...
  static associate(secret, source, target, options = {}, parent, inverse) {
    return (0, import_helpers.defineAssociation)(HasManyAssociation, source, target, options, parent, normalizeHasManyOptions, (normalizedOptions) => {
