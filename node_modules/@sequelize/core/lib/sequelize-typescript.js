...
const SUPPORTED_DIALECTS = Object.freeze(["mysql", "postgres", "sqlite", "mariadb", "mssql", "mariadb", "mssql", "db2", "snowflake", "ibmi"]);
class SequelizeTypeScript {
  ...
  validateValue(value, type) {
    if (this.options.noTypeValidation || (0, import_check.isNullish)(value)) {
      return;
    }
