...
export declare class AbstractQueryGeneratorTypeScript {
    ...
    protected get sequelize(): import("../../sequelize.js").Sequelize;
    ...
    removeConstraintQuery(tableName: TableNameOrModel, constraintName: string, options?: RemoveConstraintQueryOptions): string;
