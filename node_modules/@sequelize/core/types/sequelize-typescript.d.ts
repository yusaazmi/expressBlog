...
import type { CreateSchemaOptions, DataType, DataTypeClassOrInstance, DestroyOptions, ModelAttributes, ModelOptions, ModelStatic, QiListSchemasOptions, QueryOptions, SyncOptions, TruncateOptions } from '.';
...
export declare const SUPPORTED_DIALECTS: readonly ["mysql", "postgres", "sqlite", "mariadb", "mssql", "mariadb", "mssql", "db2", "snowflake", "ibmi"];
/**
...
export declare abstract class SequelizeTypeScript {
     ...
     */
    get queryInterface(): import(".").AbstractQueryInterface<AbstractDialect>;
    /**
