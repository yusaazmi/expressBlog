...
export declare function getObjectFromMap<K extends PropertyKey, V>(aMap: Map<K, V> | MapView<K, V>): Record<K, V>;
/**
...
export declare function noPrototype<T extends object>(obj: T): T;
export {};
